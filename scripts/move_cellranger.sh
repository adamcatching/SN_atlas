...
output_file_base=/data/CARD_singlecell/SN_atlas/data
...
do
    ...
    cp  $output_file_base"/samples/"$Sample_ID"/01_"$Sample_ID"_anndata_object_rna.h5ad" $input_file_base"batch"$Use_batch"/Multiome/"$Sample_ID"-ARC/outs/."
